...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void Encrypt_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //as we want to store fileSize and fileNameSize in the image so it should be less //than 8*((h*w)/3-1)
        ...
        {
            toolStripStatusLabel2.Text = "Decrypting... Please wait";
            Application.DoEvents();
            int i, j = 0;
            bool[] t = new bool[8];
            bool[] rb = new bool[8];
            ...
            toolStripStatusLabel2.Text = "Decrypted file has been successfully saved.";
            Application.DoEvents();
        }
