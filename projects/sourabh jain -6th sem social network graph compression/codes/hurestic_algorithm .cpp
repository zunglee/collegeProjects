...
int main()
{
    ...
    edge--;
    cout<<"-------Graph Compression using MPk Linearization With Hurestic---------\n";
    cout<<"Enter value of k : ";
    cin>>k;
    out=k;
    double rf,dt;
    cout<<"Enter Redundancy Factor(0,1) :";
    cin>>rf;
    cout<<"Enter Density Fector(0,1) : ";
    cin>>dt;
    while(edge>=1)
    {     
          ...
          while(edge>=1)
          {
                if(m.size()==0)
                 ...
                 else
                 {
                      ...
                      if(ans.size()%1000==0)
                      {
                             if ((edgecount*1.0)/(2.0*k*1000.0) <dt)
                             {
                                      k=k*rf;
                                      if(k==0)
                                              k=1;
