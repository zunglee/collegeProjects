...
static char *strtolower(char *word)//okay
{
        char *s;
...
static ENTRY *find(char *word)//okay
{
        ENTRY e;
...
static int update(char *word)////okay
{
        ENTRY *e = find(word);
...
static int read_file(ENTRY dict)//okay
{
        char *file, *word, *w;
...
static int edits1_rows(char *word)//okay
{
...
static char **edits1(char *word)//okay
{
        int next_idx;
