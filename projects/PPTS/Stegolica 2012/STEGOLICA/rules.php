    	...
    	<div style="width:960;margin:0px;">
            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.2);padding:25px;min-height:430px;width:600px;float:left;">
                    ...
                    <ul style="font-size:15px">
						<li>This is not a team event. Only individual participation is allowed.</li>
						<li>Registration is mendatory for all the participants.</li>
						<li>Event will be of 5 hours duration.</li>
						<li>There will be total of around 10-15 questions.</li>
						<li>In case of any dispute decision of the organizers will be binding.</li>
